...
const TEST_CATEGORIES: TestCategoryConfig[] = [
  {
    id: '1_discovery_engine',
    number: 1,
    name: 'Discovery Engine',
    description: 'Discovery pipeline: filesystem scan → manifest validation → dependency graph → registry population (no Runtime)',
    icon: Radar,
    color: 'emerald',
  },
  {
    id: '2_plugin_compliance',
    number: 2,
    name: 'Plugin Compliance',
    description: '100+ plugins with valid manifests — aenews version, semver, required fields, capabilities, entry points',
    icon: FileCheck2,
    color: 'sky',
  },
  {
    id: '3_capability_registry',
    number: 3,
    name: 'Capability Registry',
    description: 'Capabilities populated from Discovery — type diversity, cross-plugin indexing, search, metadata only',
    icon: Layers,
    color: 'violet',
  },
  {
    ...
    number: 4,
    name: 'Tool Registry',
    description: 'Tools registered from manifest capabilities + routes — descriptions, permissions, execute stubs',
    icon: Wrench,
    color: 'rose',
  },
  {
    ...
    number: 5,
    name: 'UI Registry',
    description: 'Sidebar menus, dashboard cards, widgets, commands, pages — all from Discovery, zero Runtime',
    icon: DatabaseZap,
    color: 'amber',
  },
  {
    id: '6_search_registry',
    number: 6,
    name: 'Search Registry',
    description: 'Search entities indexed from manifest search config — fields, labels, cross-plugin discovery',
    icon: Search,
    color: 'teal',
  },
  {
    id: '7_schema_registry',
    number: 7,
    name: 'Schema Registry',
    description: 'Object schemas from manifests — fields, relations, indexes, code generation (Prisma/API/JSON)',
    icon: Blocks,
    color: 'cyan',
  },
  {
    id: '8_workflow_registry',
    number: 8,
    name: 'Workflow Registry',
    description: 'Triggers from events, actions from capabilities — workflow building blocks before activation',
    icon: GitCompare,
    color: 'orange',
  },
  {
    ...
    number: 9,
    name: 'Agent Registry',
    description: 'AI agents auto-discovered from manifests — system prompts, tools, capabilities, tags',
    icon: Bot,
    color: 'purple',
  },
  {
    id: '10_knowledge_registry',
    number: 10,
    name: 'Knowledge Registry',
    description: 'Knowledge entries from manifests — guides, FAQs, policies — searchable, typed, tagged',
    icon: BookOpen,
    color: 'indigo',
  },
  {
    id: '11_permission_engine',
    number: 11,
    name: 'Permission Engine',
    description: 'Dot-notation permissions from manifests — patterns, wildcards, cross-plugin uniqueness',
    icon: ShieldCheck,
    color: 'pink',
  },
  {
    id: '12_dependency_graph',
    number: 12,
    name: 'Dependency Graph',
    description: 'Topological sort, cycle detection, edge validation, orphan plugin identification',
    icon: GitBranch,
    color: 'lime',
  },
  {
    id: '13_plugin_runtime',
    number: 13,
    name: 'Plugin Runtime',
    description: 'Discovery/Activation separation — Runtime lifecycle methods, zero metadata registration',
    icon: Zap,
    color: 'rose',
  },
  {
    ...
    description: '100+ plugins: scan time, bootstrap speed, memory usage, registry throughput, Discovery performance',
    icon: Gauge,
    color: 'amber',
  },
  {
    ...
    description: 'Satellite Management plugin (unknown domain) auto-discovered — sidebar, search, dashboard, IA, all registries',
    icon: Trophy,
    color: 'emerald',
  },
];
          ...
          <div className="flex items-center gap-3 mb-1">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                PHASE ULTIME — Discovery-First Architecture · 15 Test Categories · 121 Plugins
              </p>
            </div>
          </div>
        </div>
